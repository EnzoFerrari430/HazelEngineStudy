...
不同平台的消息通过function转换成Hazel自己的消息id
比如：
GLFWKeyCodeToHZKeyCode
HZKeyCodeToGLFWKeyCode

Win32KeyCodeToHZKeyCode
HZKeyCodeToWin32KeyCode

这里默认使用了GLFW的keycodes所以GLFW的窗口就不用进行转换了
*/
